...
/**
 * ListFragment for Causes
 */
public class ListCauses
	...
	public void onActivityCreated (Bundle savedInstanceState) {
		...
		adapter = new SimpleCursorAdapter(getActivity(), R.layout.listitem_library_causes, null, new String[] {Cause._DETAILS}, new int[] {R.id.textview_details__listitem_library_causes}, 0);
	...
	public Loader<Cursor> onCreateLoader (int id, Bundle args) {
		return new nyshgale.android.mediapp.custom.Loader(getActivity(), Cause.TYPE);
	}
	...
	public boolean onItemLongClick (AdapterView<?> parent, View view, int position, long id) {
		if (callback != null) {
			callback.onItemLongClicked(new Cause(id));
		}
		return true;
	}
	...
	public void onItemClick (AdapterView<?> parent, View view, int position, long id) {
		DialogInfo.create(new Cause(id)).show(getActivity().getFragmentManager(), null);
	}
}
