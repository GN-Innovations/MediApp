...
public class ListSymptoms
	...
	public void onActivityCreated (Bundle savedInstanceState) {
		...
		adapter = new SimpleCursorAdapter(getActivity(), R.layout.listitem_library_symptoms, null, new String[] {Symptom._NAME}, new int[] {R.id.textview_name__listitem_library_symptoms}, 0);
	...
	public Loader<Cursor> onCreateLoader (int id, Bundle args) {
		return new nyshgale.android.mediapp.custom.Loader(getActivity(), Symptom.TYPE);
	}
	...
	public boolean onItemLongClick (AdapterView<?> parent, View view, int position, long id) {
		if (callback != null) {
			callback.onItemLongClicked(new Symptom(id));
		}
		return true;
	}
	...
	public void onItemClick (AdapterView<?> parent, View view, int position, long id) {
		DialogInfo.create(new Symptom(id)).show(getActivity().getFragmentManager(), null);
	}
