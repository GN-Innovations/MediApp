...
/**
 * ListFragment for Illnesses
 */
public class ListIllnesses
	...
	public void onActivityCreated (Bundle savedInstanceState) {
		...
		adapter = new SimpleCursorAdapter(getActivity(), R.layout.listitem_library_illnesses, null, new String[] {Illness._NAME, Illness._DESCRIPTION}, new int[] {R.id.textview_name__listitem_library_illnesses, R.id.textview_description__listitem_library_illnesses}, 0);
	...
	public Loader<Cursor> onCreateLoader (int id, Bundle args) {
		return new nyshgale.android.mediapp.custom.Loader(getActivity(), Illness.TYPE);
	}
	...
	public boolean onItemLongClick (AdapterView<?> parent, View view, int position, long id) {
		if (callback != null) {
			callback.onItemLongClicked(new Illness(id));
		}
		return true;
	}
	...
	public void onItemClick (AdapterView<?> parent, View view, int position, long id) {
		DialogInfo.create(new Illness(id)).show(getActivity().getFragmentManager(), null);
	}
