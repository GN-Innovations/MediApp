...
/**
 * ListFragment for Medications
 */
public class ListMedications
	...
	public void onActivityCreated (Bundle savedInstanceState) {
		...
		adapter = new SimpleCursorAdapter(getActivity(), R.layout.listitem_library_medications, null, new String[] {Medication._NAME}, new int[] {R.id.textview_name__listitem_library_medications}, 0);
	...
	public Loader<Cursor> onCreateLoader (int id, Bundle args) {
		return new nyshgale.android.mediapp.custom.Loader(getActivity(), Medication.TYPE);
	}
	...
	public boolean onItemLongClick (AdapterView<?> parent, View view, int position, long id) {
		if (callback != null) {
			callback.onItemLongClicked(new Medication(id));
		}
		return true;
	}
	...
	public void onItemClick (AdapterView<?> parent, View view, int position, long id) {
		DialogInfo.create(new Medication(id)).show(getActivity().getFragmentManager(), null);
	}
